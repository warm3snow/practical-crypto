...
openssl req -new -key ../testdata/server.key -out ../testdata/server.csr -subj $SUBJ

# issue certificate => crt
openssl x509 -req -sha256 -days 365 -in ../testdata/server.csr -signkey ../testdata/server.key -out ../testdata/server.crt
